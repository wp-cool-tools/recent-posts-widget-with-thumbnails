...
<label for="<?php echo esc_attr( $field_ids[ 'open_new_window' ] ); ?>"><?php esc_html_e( 'Open post links in new windows?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'hide_current_post' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'hide_current_post' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'hide_current_post' ) ); ?>" />
    <label for="<?php echo esc_attr( $field_ids[ 'hide_current_post' ] ); ?>"><?php esc_html_e( 'Do not show the current post?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><label for="<?php echo esc_attr( $field_ids[ 'orderby' ] ); ?>"><?php esc_html_e( 'Order by', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
    <select id="<?php echo esc_attr( $field_ids[ 'orderby' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'orderby' ) ); ?>">
...
<p><label for="<?php echo esc_attr( $field_ids[ 'order' ] ); ?>"><?php esc_html_e( 'Sort', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
    <select id="<?php echo esc_attr( $field_ids[ 'order' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'order' ) ); ?>">
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'hide_sticky_posts' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'hide_sticky_posts' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'hide_sticky_posts' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'hide_sticky_posts' ] ); ?>"><?php esc_html_e( 'Do not show sticky posts?', 'recent-posts-widget-with-thumbnails' ); ?><br />
...
<p><label for="<?php echo esc_attr( $field_ids[ 'author_label' ] ); ?>"><?php esc_html_e( 'Label for authors:', 'recent-posts-widget-with-thumbnails' ); ?></label>
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'set_cats_as_links' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'set_cats_as_links' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'set_cats_as_links' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'set_cats_as_links' ] ); ?>"><?php esc_html_e( 'Set post category names as links, pointing to their archives?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><label for="<?php echo esc_attr( $field_ids[ 'category_label' ] ); ?>"><?php esc_html_e( 'Label for categories:', 'recent-posts-widget-with-thumbnails' ); ?></label>
...
<p><label for="<?php echo esc_attr( $field_ids[ 'excerpt_length' ] ); ?>"><?php esc_html_e( 'Maximum length of excerpt', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
<input id="<?php echo esc_attr( $field_ids[ 'excerpt_length' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'excerpt_length' ) ); ?>" type="text" value="<?php echo absint( $ints[ 'excerpt_length' ] ); ?>" size="3" /></p>

<p><label for="<?php echo esc_attr( $field_ids[ 'excerpt_more' ] ); ?>"><?php esc_html_e( 'Signs after excerpt', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
<input id="<?php echo esc_attr( $field_ids[ 'excerpt_more' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'excerpt_more' ) ); ?>" type="text" value="<?php echo esc_attr( $optional_texts[ 'excerpt_more' ] ); ?>" size="3" /></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'set_more_as_link' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'set_more_as_link' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'set_more_as_link' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'set_more_as_link' ] ); ?>"><?php esc_html_e( 'Set signs after excerpt as a link to the post?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'ignore_excerpt' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'ignore_excerpt' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ignore_excerpt' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'ignore_excerpt' ] ); ?>"><?php esc_html_e( 'Ignore post excerpt field as excerpt source?', 'recent-posts-widget-with-thumbnails' ); ?></label><br />
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'ignore_post_content_excerpt' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'ignore_post_content_excerpt' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'ignore_post_content_excerpt' ) ); ?>" />
...
<p><label for="<?php echo esc_attr( $field_ids[ 'thumb_dimensions' ] ); ?>"><?php esc_html_e( 'Size of thumbnail', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
	<select id="<?php echo esc_attr( $field_ids[ 'thumb_dimensions' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'thumb_dimensions' ) ); ?>">
		<option value="<?php echo esc_attr( $this->defaults[ 'thumb_dimensions' ] ); ?>" <?php selected( $thumb_dimensions, $this->defaults[ 'thumb_dimensions' ] ); ?>><?php esc_html_e( 'Specified width and height', 'recent-posts-widget-with-thumbnails' ); ?></option>
<?php
...
<p><label for="<?php echo esc_attr( $field_ids[ 'thumb_width' ] ); ?>"><?php esc_html_e( 'Width of thumbnail', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
<input id="<?php echo esc_attr( $field_ids[ 'thumb_width' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'thumb_width' ) ); ?>" type="text" value="<?php echo absint( $ints[ 'thumb_width' ] ); ?>" size="3" /></p>

<p><label for="<?php echo esc_attr( $field_ids[ 'thumb_height' ] ); ?>"><?php esc_html_e( 'Height of thumbnail', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
<input id="<?php echo esc_attr( $field_ids[ 'thumb_height' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'thumb_height' ) ); ?>" type="text" value="<?php echo absint( $ints[ 'thumb_height' ] ); ?>" size="3" /></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'keep_aspect_ratio' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'keep_aspect_ratio' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'keep_aspect_ratio' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'keep_aspect_ratio' ] ); ?>"><?php esc_html_e( 'Use aspect ratios of original images?', 'recent-posts-widget-with-thumbnails' ); ?><br />
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'try_1st_img' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'try_1st_img' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'try_1st_img' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'try_1st_img' ] ); ?>"><?php esc_html_e( "Try to use the post's first image if post has no featured image?", 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'only_1st_img' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'only_1st_img' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'only_1st_img' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'only_1st_img' ] ); ?>"><?php esc_html_e( 'Use first image only, ignore featured image?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'use_default' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'use_default' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'use_default' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'use_default' ] ); ?>"><?php esc_html_e( 'Use default thumbnail if no image could be determined?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'use_default_only' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'use_default_only' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'use_default_only' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'use_default_only' ] ); ?>"><?php esc_html_e( 'Ignore all thumbnails and always use only the default thumbnail?', 'recent-posts-widget-with-thumbnails' ); ?></label></p>

<p><label for="<?php echo esc_attr( $field_ids[ 'default_url' ] ); ?>"><?php esc_html_e( 'URL of default thumbnail (start with https://)', 'recent-posts-widget-with-thumbnails' ); ?>:</label>
<input class="widefat" id="<?php echo esc_attr( $field_ids[ 'default_url' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'default_url' ) ); ?>" type="text" value="<?php echo esc_url( $default_url ); ?>" /></p>
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'hide_alt_texts' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'hide_alt_texts' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'hide_alt_texts' ) ); ?>" />
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'use_inline_css' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'use_inline_css' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'use_inline_css' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'use_inline_css' ] ); ?>"><?php esc_html_e( 'Print inline CSS instead of creating a CSS file?', 'recent-posts-widget-with-thumbnails' ); ?></label><br />
...
<p><input class="checkbox" type="checkbox" <?php checked( $bools[ 'use_no_css' ] ); ?> id="<?php echo esc_attr( $field_ids[ 'use_no_css' ] ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'use_no_css' ) ); ?>" />
<label for="<?php echo esc_attr( $field_ids[ 'use_no_css' ] ); ?>"><?php esc_html_e( 'No CSS generation at all, neither inline CSS nor a CSS file?', 'recent-posts-widget-with-thumbnails' ); ?></label><br />
<em><?php esc_html_e( 'If activated this option applies to all instances of this widget.', 'recent-posts-widget-with-thumbnails' ); ?></em></p>

<p><?php esc_html_e( 'Do you like the plugin?', 'recent-posts-widget-with-thumbnails' ); ?> <a href="https://wordpress.org/support/plugin/recent-posts-widget-with-thumbnails/reviews/" target="_blank" aria-label="<?php esc_html_e( 'Please rate it at wordpress.org!', 'recent-posts-widget-with-thumbnails' ); ?>"><?php esc_html_e( 'Please rate it at wordpress.org!', 'recent-posts-widget-with-thumbnails' ); ?></a></p>

<p><strong><?php esc_html_e( 'Are you looking for more options?', 'recent-posts-widget-with-thumbnails' ); ?></strong> <a href="https://www.kybernetik-services.com/plugins/ultimate-post-list-pro/?utm_source=wordpress_org&utm_medium=plugin&utm_campaign=recent-posts-widget-with-thumbnails&utm_content=widget-form" target="_blank" aria-label="<?php esc_html_e( 'Check out Ultimate Post List Pro!', 'recent-posts-widget-with-thumbnails' ); ?>"><?php esc_html_e( 'Check out Ultimate Post List Pro!', 'recent-posts-widget-with-thumbnails' ); ?></a></p>
